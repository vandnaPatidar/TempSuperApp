...
const pagesData = [
  {
    ...
    description: 'Login 2 new policies before month end, & make 3.5k incentive for each NOP',
  ...
  },
  {
    ...
    description: 'Check if they are interested to purchase a new policy or have any referral',
  ...
  return (
    <PagerView style={styles.pagerView} initialPage={0}>
      {pagesData?.map((page, index) => (
        <View
          key={index.toString()}
          style={[styles.page, { backgroundColor: page.condition }]}
        >
            <View style={styles.animatedImage}>
             ...
             {/* <LottieView  source={require('../../../../assets/rupee-note.json')} autoPlay loop />  */}
          ...
          <View style={styles.onPressLaterAndButton}>
                <Text style={{fontSize:20 ,textDecorationLine:'underline' ,color:'white'}} onPress={console.log("pressed")}>{page.buttonTitleLater}</Text>
                <View
                  style={{
